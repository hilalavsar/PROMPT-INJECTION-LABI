...
* **Seviye 3:** Karakter taklidi ve rol yapma (roleplay) saldırıları.
* **Seviye 5:** Gelişmiş kodlanmış (encoded/Base64) saldırı vektörleri.
...
* **Framework:** Unsloth (Hızlı Fine-tuning)
* **Teknikler:** LoRA, QLoRA, 8-bit Quantization
